	...
	<view class="box">
		...
		<view class="ul">
			<view class="li">
				...
				<view class="shu"></view>
				<input v-model="user.username" maxlength="11" placeholder-style="color: #AFAFB8" class="pr" type="number"
					placeholder="请输入手机号" />
			</view>
			<view class="li">
		...
		<view class="btn_login" :class="user.username.length == 11 && password ? 'btn2' : 'btn2'" @click="login">登录
		</view>
